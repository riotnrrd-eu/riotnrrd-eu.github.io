...
The most frequently cited category of objections in the survey is "Effect on resources"; the sub-category of "Water/Excess water usage" heads the list, cited by 18% of respondents who oppose datacenter construction. Now this is a weird one, because of all the many possible objections to AI, water consumption seems to be the one that has taken off with the general public. It's weird because this is the *least substantiated objection to AI*.
