---
layout: post
title:  Compute Me A Moat!
date:   2026-04-14
categories:  AI OpenAI Oracle
---

A couple of weeks ago, I went looking for [a competitive moat for AI]({% post_url 2026-03-31-Networked-Intelligence %}), and among other candidates, I suggested that compute probably wasn't it:
...
I understand why OpenAI would *want* their massive investment in compute capacity to constitute "durable business leverage", but it's far from clear that it actually does. The [Stargate datacenter that Oracle was building for OpenAI in Texas is dead](https://finance.yahoo.com/sectors/technology/articles/microsoft-rent-texas-data-center-151635052.html), and according to [this toot by Mark Newton](https://eigenmagic.net/@NewtonMark/116396474617765593), the UK datacenter is even worse off:
...
> 
> [https://www.afr.com/technology/openai-pauses-stargate-uk-data-centre-citing-energy-costs-20260410-p5zmq8](https://www.afr.com/technology/openai-pauses-stargate-uk-data-centre-citing-energy-costs-20260410-p5zmq8) [@davidgerard](https://circumstances.run/@davidgerard)

Other datacenter builds might also be in trouble, as according to the *Wall Street Journal*, [We’re Using So Much AI That Computing Firepower Is Running Out](https://www.wsj.com/tech/ai/ai-is-using-so-much-energy-that-computing-firepower-is-running-out-156e5c85). I don't have access to the WSJ, so I am once again relying on [the excerpt from Charles Arthur's invaluable *The Overspill*](https://theoverspill.blog/2026/04/14/internet-archive-publishers-block-chatbot-start-up-2651/#6aae50a9719ba264941e75eb37765572):
...
🖼️  Photos by [Colin Watts](https://unsplash.com/@colinwatts) on [Unsplash](https://www.unsplash.com)